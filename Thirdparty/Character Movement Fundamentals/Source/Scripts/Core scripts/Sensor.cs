...
namespace CMF
{
    ...
    public class Sensor
    {
        ...
        {
            Vector3 _worldDirection = Vector3.down;
            Vector3 _worldOrigin = tr.TransformPoint(origin);
            hasDetectedHit = Physics.Raycast(_worldOrigin, _worldDirection, out RaycastHit _hit, castLength, layermask, QueryTriggerInteraction.Ignore);
