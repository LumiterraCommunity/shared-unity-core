...
namespace CMF
{
    ...
    public class Mover : MonoBehaviour
    {
        ...
        public float StepHeightRatio => stepHeightRatio;
        ...
        public Vector3 ColliderOffset => colliderOffset;
        ...
        //Set offset of collider;
        public void SetColliderOffset(Vector3 _newColliderOffset)
        {
            if (colliderOffset == _newColliderOffset)
                return;

            colliderOffset = _newColliderOffset;
            RecalculateColliderDimensions();
        }
